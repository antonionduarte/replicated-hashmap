...
/**
 * This is NOT fully functional StateMachine implementation. This is simply an example of things you can do, and can be
 * used as a starting point.
 * <p>
 * You are free to change/delete anything in this class, including its fields. The only thing that you cannot change are
 * the notifications/requests between the StateMachine and the APPLICATION You can change the requests/notification
 * between the StateMachine and AGREEMENT protocol, however make sure it is coherent with the specification shown in the
 * project description.
 * <p>
