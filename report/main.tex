...
We evaluated the performance of two replicated hashmap systems using state-machine replication, one of which implemented Paxos and the other implemented Multipaxos.
